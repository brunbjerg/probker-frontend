...
# !!! Main.UserApp is configured as an alias for Main.ProbkerApp and you might encounter it in some tests
using Main.ProbkerApp, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "ProbkerApp tests" begin
  @includetests ARGS
end
